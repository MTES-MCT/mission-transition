                ...
                <div className="fr-grid-row">
                    <div className="fr-col fr-mx-9w fr-my-7w">
                        ...
                        <select id="search_form_environmentalTopic" name="search_form[environmentalTopic]"
                            ...
                            <option value="Conservation et restauration des écosystèmes">Conservation et restauration
                                des écosystèmes
                            </option>
                            <option value="Économie circulaire" selected="selected">Économie circulaire</option>
                            <option value="Efficacité énergétique">Efficacité énergétique</option>
                            <option value="Limiter les déplacements">Limiter les déplacements</option>
                            <option value="Mobilité partagée">Mobilité partagée</option>
                            <option value="Mobilité pour tous">Mobilité pour tous</option>
                            <option value="Production et distribution d'énergie">Production et distribution d'énergie
                            </option>
                        </select>
